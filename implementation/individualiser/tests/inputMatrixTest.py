...
if input_matrix[1][0] == all_subjects[0]['hrir_r'][0][0][0]:
    print "test2 success!"
else: 
    print "test2 failed"
...
if input_matrix[201][56249] == all_subjects[44]['hrir_r'][24][49][100]:
...
if input_matrix.shape[0] == 202 and input_matrix.shape[1] == 56250:
    print "test5 success!"
else:
    print "test5 failed"
...
if input_matrix[1][0] == test_mean2:
    print "test1 success!"
else:
    print input_matrix[0][0]
    print test_mean2
